...
public class WallService {
        ...
        public  LinkedHashMap<String, Object> serve(String commandName, HashMap<String, String> request) throws ClassNotFoundException, InstantiationException, IllegalAccessException{
