...
public class ReturnedReply {
	...
	public void set(String attributeName, Object val) {
		...
		case "parentCommentId":
			setParentCommentId(val.toString());
			break;
		case "text":
	...
	public String toString() {
		return "ReturnedReply{" + "replyId='" + replyId + '\'' + ", authorId='" + authorId + '\'' + ", parentPostId='"
				+ parentPostId + '\'' + ", parentCommentId='" + parentCommentId + '\'' + ", text='" + text + '\''
				+ ", timestamp=" + timestamp + ", authorName='" + authorName + '\'' + ", authorProfilePictureUrl='"
				+ authorProfilePictureUrl + '\'' + ", liked=" + liked + ", likers=" + likers + '}';
	}
}
